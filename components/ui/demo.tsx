...
export default function DemoOne() {
  return (
    <div className="space-y-20">
      ...
      />
      <div className="px-6">
        <TextGenerateEffect duration={2} filter={false} words={`Oxygen gets you high. In a catastrophic emergency, we're taking giant, panicked breaths. Suddenly you become euphoric, docile. You accept your fate. It's all right here. Emergency water landing, six hundred miles an hour. Blank faces, calm as Hindu cows`} />
      </div>
    </div>
  );
}
