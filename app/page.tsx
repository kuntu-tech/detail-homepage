...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="max-w-md mx-auto mb-12">
            <Card className="p-8 hover:shadow-lg transition-shadow bg-black border-2 border-gray-700">
              <div className="text-sm font-semibold text-gray-400 mb-2">SUBSCRIPTION</div>
              ...
              <div className="space-y-3 text-left mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-white">Unlimited datasets and apps</span>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path
                  ...
                  <span className="text-sm text-white">AI-powered market analysis</span>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path
                  ...
                  <span className="text-sm text-white">ChatGPT Store publishing</span>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-white font-semibold">Keep 100% of your revenue</span>
                </div>
              </div>
              <Button 
      ...
      <WaitlistDialog open={waitlistOpen} onOpenChange={setWaitlistOpen} onJoined={handleJoined} />
    </div>
  );
}
